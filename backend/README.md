...
## Project Structure
    ...
    ├── testapiautosetting_126990  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126990`
...
2. Clone this repo and `cd testapiautosetting_126990`
